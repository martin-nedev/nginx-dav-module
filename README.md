...
Default: off
Context: http, server, location
Description: Enables the specified HTTP and WebDAV methods. Use "on" to enable all supported methods: PUT, DELETE, MKCOL, COPY, MOVE, LOCK, UNLOCK, PROPFIND, PROPPATCH, OPTIONS. Note: LOCK and UNLOCK require a lock zone and must be enabled together.
